...
/* ##005## (driver Object)(Boiler Plate)
			- Driver Object has 4 internal Objects
			1.) A Mutex for locking object - (https://tour.golang.org/concurrency/9)
			2.) 2 Map of String to logPairs (##006##)
				TODO logs is used for ???
				TODO idx is used for ???
			3.) A Logger interface (github.com/docker/docker/daemon/logger/logger.go)
 */
type driver struct {
	mu     sync.Mutex
...
/* ##004## (Build Driver)(Boiler Plate)
			- Return a new Driver Object(##005##)
			- With built in logPair Objects(##006##)
			- Return back to called function(##007##)
*/
...
/*
##016## (StartLogging Implementation (Custom)
